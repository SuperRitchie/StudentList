...
//Test 1: Insert student
do{
  DomesticStudent* student1;
  list1->insert();
  cout << "The new student list is: ";
  list1->print;
  cout << "Test again? 1 for yes";
  int input;
  cin >> int;
}while (input == 1);

//Test 2: Search student with cgpa
do{
  int student2 = 3.0;
  list2->searchCGPA();
  cout << "Test again? 1 for yes";
...
//Test 3: Search student with name
do{
  string student3 = "Oliver Morris";
  list1->searchName();
  cout << "Test again? 1 for yes";
  int input;
  cin >> input;
...
//Test 5: Delete head and tail nodes
do{
  list1.delht();
  list2.delht();
  list1->print;
...
//Test 6: Merge domestic and international student lists
do{
...
//Test 7: Search existing student in merged list
do{
